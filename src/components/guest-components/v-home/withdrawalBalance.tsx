...
import { TrendingUp, TrendingDown, WalletIcon, ArrowUpRight } from "lucide-react"; // Replace with the correct icon names from lucide-react
...
const WithdrawalBalance: FC<EarningsCardProps> = ({ title, amount, change, isPositive }) => {
  return (
